...
class CustomUser(AbstractUser):
    """
    Clase Usuario, se adiciona el campo authorization para controlar las vistas a mostrar
    """
...
class Empleado(Model):
    """
    Clase empleado, que representa a los entrenadores y otros empleados
    """
...
class Cliente(Model):
    """
    Clase cliente, representa a los clientes
    """
    nombre = models.CharField(max_length=30, null=False,blank=False)
    apellidos = models.CharField(max_length=50, null=False,blank=False,unique=True)
